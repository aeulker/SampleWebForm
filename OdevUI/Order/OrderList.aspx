<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpages/Account.Master" AutoEventWireup="true" CodeBehind="OrderList.aspx.cs" Inherits="OdevUI.Order.OrderList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainBody" runat="server">
    ...
    <div style="padding: 0px 20px; width: 100%;">
        <asp:GridView ID="gvOrderDetail" runat="server" AllowPaging="True" DataKeyNames="Id"
            ...
            BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" EmptyDataText="Sipariş kaydı bulunmuyor" ShowHeaderWhenEmpty="True" Caption="Sipariş Detayı" CaptionAlign="Top">
            <Columns>
